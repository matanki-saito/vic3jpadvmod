...
def main():
    ...
    s3.Bucket(bucket_name).download_file("steamcmd/ssfn46271041249703416",
                                         "steamcmd/ssfn46271041249703416")
    s3.Bucket(bucket_name).download_file("steamcmd/ssfn7672163446140081984",
                                         "steamcmd/ssfn7672163446140081984")
